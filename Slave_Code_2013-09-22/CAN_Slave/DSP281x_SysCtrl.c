...
//    SysCtrlRegs.WDCR= 0000 0000 0110 1000;
...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
   SysCtrlRegs.HISPCP.all = 0x0; // InitPeripheralClocks() ==>     SysCtrlRegs.HISPCP.all = 0x0000; ==> HSPCLK = SYSCLKOUT
   	   	   	   	   	   	   	   	   	// If HISPCP != 0, HSPCLK = SYSCLKOUT/(HISPCP X 2)
   									// If HISPCP = 0, HSPCLK = SYSCLKOUT
   	   	   	   	   	   	   	   	    // If HISPCP = 3 ==> HSPCLK = SYSCLKOUT/(2*3) = 25MHz
